Instance: EMPatientValidExample
...
Instance: EMPatientInvalidExample
InstanceOf: Patient
Usage: #example
Title: "Invalid Emergency Patient"
Description: """
An intentionally non-conformant Patient instance used to demonstrate
validation errors against the Emergency Patient profile.
"""

// Tell the validator that this Patient claims conformance to the profile.
* meta.profile[0] = Canonical(EMPatient)
